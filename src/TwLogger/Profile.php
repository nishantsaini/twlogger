...
class TwLogger_Profile
{
     ...
     *
     * @return TwLogger_Profile A new instance with exclusive data set.
     */
     ...
     *
     * @param TwLogger_Profile $head The other run to compare with
     * @return array An array of comparison data.
     */
    public function compare(TwLogger_Profile $head)
    {
        $this->calculateSelf();
        $head->calculateSelf();
